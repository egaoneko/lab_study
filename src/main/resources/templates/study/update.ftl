            ...
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 panel panel-default">
                <section>
                    <form role="form" action="" method="post" class="form-horizontal">
                        ...
                        <fieldset>
                            <legend class="text-center">Study Update</legend>

                            <div class="form-group">
                                <label for="title" class="col-lg-2 control-label">Title</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="title" id="title" placeholder="Title" size="50" value="${form.title}" required autofocus>
                                </div>
                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody id="list_study_book">
                                                <tr class="__emptylist__study" style="<#if form.books?has_content>display: none<#elseif form.bookSet?has_content>display: none<#else></#if>">
                                                ...
                                                <#elseif form.bookSet?has_content>
                                                    <#list form.bookSet as book>
                                                        <tr id="book_${book.id}" class="__oldlist__study">
                                                            <td><img src="${book.image}"  width="50px" height="70px" /></td>
                                                            <td>${book.title}</td>
                            ...
                            <div class="form-group">
                                <div class="col-lg-12 text-center">
                                    <input type="button" class="btn btn-danger" onclick="location.href='/study/read/${form.id}'" value="Cancel"/>
