...
public class MailUtils {
    ...
    private SimpleMailMessage sendMailByFile(User user, String mailSubject, String msgTextFileName, String urlInMessage) {
        ...
        String mailBody = VelocityEngineUtils.mergeTemplateIntoString(velocityEngine, filePathRoot + filePathEn + msgTextFileName, VELOCITY_ENCODING, model);
